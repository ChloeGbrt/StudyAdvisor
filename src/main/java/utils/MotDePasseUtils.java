...
public class MotDePasseUtils {
	...
	public static void main(String[] args) {
		try {
			System.out.println(String.format("Admin=%s", MotDePasseUtils.genererMotDePasse("Aetuo79")));
			System.out.println(String.format("Alex=%s", MotDePasseUtils.genererMotDePasse("azerty")));
